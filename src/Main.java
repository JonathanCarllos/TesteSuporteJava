...
public class Main {
	...
	public static void main(String[] args) {
		...
		Usuario usuario1 = new Usuario("admin", "1234", null, null, admin);
				...
				if (usuarioLogado.IsEmpresa()) {
					...
					switch (escolha) {
						case 1: {
							...
							empresas.forEach(empresaItem -> {
								System.out.println("************************************************************");
								System.out.println("ID: " + empresaItem.getId());
								System.out.println("Nome: " + empresaItem.getNome());
								System.out.println("CNPJ: " + empresaItem.getCnpj());
								System.out.println("Saldo: " + empresaItem.getSaldo());
								System.out.println("Taxa: " + empresaItem.getTaxa());
								System.out.println("************************************************************");
						...
						// Restante do código para as outras opções
					}
				} else {
